import { Channel, ClientBase, ConnectionBase } from "./connBase.js";

export abstract class PeerlessClient<ConnectionType extends ConnectionBase<any>, Channel> extends ClientBase<ConnectionType> {
